...
#define HARDWARE_SPI0_INITIALIZE() do { \
		gpio0_pin_initialize(22, GPIO_IO_TYPE_PERIPHERAL, GPIO_NOPULL, GPIO_SPEED_LOW, GPIO_AF_1); /* GPIO 22: SPI0 SCK */ \
		gpio0_pin_initialize(23, GPIO_IO_TYPE_PERIPHERAL, GPIO_NOPULL, GPIO_SPEED_LOW, GPIO_AF_1); /* GPIO 23: SPI0 TX */ \
		gpio0_pin_initialize(24, GPIO_IO_TYPE_PERIPHERAL, GPIO_NOPULL, GPIO_SPEED_LOW, GPIO_AF_1); /* GPIO 24: SPI0 RX */ \
		} while (0)
